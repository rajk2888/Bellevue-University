...
(function (SW) {
  ...
  const topics = [
    ...
    t("add-within-20", "Adding within 20", "Addition & Subtraction", 1, { engine: "addition",
      concept: "Adding puts two groups together to find how many in all. Start with the bigger number and count on.",
      story: "You have 8 marbles and a friend gives you 5 more. How many now?", standards: { ccss: "1.OA.C.6" },
      opts: { maxSum: 20 }, goals: ["Put two groups together to find how many in all", "Count on from the bigger number", "Check your answer with dots or a number line"] }),
    t("sub-within-20", "Subtracting within 20", "Addition & Subtraction", 1, { engine: "subtraction",
      concept: "Taking away means some are gone. Start with how many you have and hop back.",
      story: "There are 15 cookies on a plate and 6 get eaten. How many are left?",
      goals: ["Take some away to find how many are left", "Hop back on a number line", "Check your answer with dots"] }),
    ...
    t("add-2digit", "Adding two-digit numbers", "Addition & Subtraction", 2, { engine: "addition",
      concept: "Add the ones first, then the tens. Ten ones make one new ten.",
      story: "A class collects 38 cans on Monday and 27 on Tuesday.",
      opts: { twoDigit: true }, goals: ["Add ones with ones and tens with tens", "Make a new ten when you have 10 ones", "Use ten-sticks and cubes to check"] }),
